...
class SupersetBulletChartV7 extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Bullet Chart v7',
      name: (0, _core.t)('Superset Bullet Chart v7'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetBulletChartV7'))),
      metadata,
